...
This chart shows the daily low, high, open and close of Apple stock. Each “candle” represents a single trading day. A specialized *x*-axis is used to avoid gaps on the weekend when the markets are closed. Compare to a [line chart](/@d3/line-chart). Data: [Yahoo Finance](https://finance.yahoo.com/lookup)`
)}

function _chart(CandlestickChart,aapl,width){return(
...
FileAttachment("aapl-2.csv").csv({typed: true}).then(data => data.slice(-120))
)}

function _4(howto){return(
howto("CandlestickChart")
)}
...
function _CandlestickChart(d3){return(
